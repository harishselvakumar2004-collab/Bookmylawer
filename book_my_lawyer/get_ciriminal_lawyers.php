...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    // Optional keyword from query param
    $keyword = $_GET['keyword'] ?? 'Criminal';

    // Use wildcard search on both columns
    ...
    if (count($lawyers) > 0) {
        ...
        echo json_encode(["success" => false, "message" => "No matching lawyers found."]);
    }
